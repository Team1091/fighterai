...
class Telemetry(
    ...
    val secondaryWeaponDuration: Float = 10f,
    val secondaryWeaponAmmo: Int = 0,
    val faction: Faction = Faction.UNALIGNED,
    val radius: Float = 1f,
) {

    val primaryWeaponRange = primaryWeaponDuration * primaryWeaponVelocity
    val secondaryWeaponRange = secondaryWeaponDuration * secondaryWeaponVelocity
}